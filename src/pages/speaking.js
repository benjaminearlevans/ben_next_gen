          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
              {speakingEngagements.map((engagement) => (
                <Card key={engagement.id} className="bg-gray-900 border-gray-800 overflow-hidden group cursor-pointer">
                  <Link to={`/speaking/${engagement.slug}/`}>
                    <div className="aspect-video bg-gray-800 relative overflow-hidden">
                      <div className="absolute inset-0 bg-gradient-to-br from-blue-600/20 to-purple-600/20" />
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="w-16 h-16 bg-white/10 rounded-full flex items-center justify-center backdrop-blur-sm group-hover:bg-white/20 transition-colors">
                    ...
                    <CardContent className="p-6">
                      ...
                      <p className="text-gray-400 text-sm mb-1">{engagement.event_name}</p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
              {podcastEpisodes.map((episode) => (
                <Card key={episode.id} className="bg-gray-900 border-gray-800 overflow-hidden group cursor-pointer">
                  <Link to={`/podcast/${episode.slug}/`}>
                    ...
                    <CardContent className="p-4">
                      <h3 className="text-base font-semibold text-white mb-1 group-hover:text-green-400 transition-colors line-clamp-2">
                        {episode.title}
                      </h3>
                      <p className="text-gray-400 text-sm">{episode.podcast_name}</p>
                    </CardContent>
                  </Link>
                </Card>
              ))}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {pastAudiences.map((audience, index) => (
                <div key={index} className="border-l-2 border-gray-700 pl-4 py-2">
                  <h3 className="text-white font-semibold mb-1">{audience.name}</h3>
